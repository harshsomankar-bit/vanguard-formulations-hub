...
export const institutionalFaqs: FaqItem[] = [
  {
    ...
    answer:
      "You can place a bulk medicine supply or hospital rate contract inquiry directly via our Trade Desk inquiry form below, by emailing us at trade@reditionpharma.com, or by calling our commercial desk at +91 98250 12345. Please mention the desired formulation names (ADNOSINE-108, MACSINE-109, PREDY-NT, QLONG-GOLD, or ADNOCAR-DS Syrup), required batch quantity, delivery destination, and entity type. Our institutional trade team issues formal quotation dossiers within 24 business hours.",
  },
  {
